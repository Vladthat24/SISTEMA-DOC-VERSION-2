...
CREATE TABLE IF NOT EXISTS `dbregistrodocumento`.`persona_trabajador` (
  `idpersona_trabajador` INT NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`idpersona_trabajador`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `dbregistrodocumento`.`trabajador` (
  ...
  CONSTRAINT `fk_persona_trabajador_trabajador`
    ...
    REFERENCES `dbregistrodocumento`.`persona_trabajador` (`idpersona_trabajador`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `dbregistrodocumento`.`oficio` (
  ...
  INDEX `fk_trabajador_oficio_idx` (`idotrabajador` ASC),
  CONSTRAINT `fk_trabajador_of`
    FOREIGN KEY (`idotrabajador`)
    REFERENCES `dbregistrodocumento`.`trabajador` (`idptrabajador`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
