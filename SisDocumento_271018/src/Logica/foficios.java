...
public class foficios {
    ...
    public DefaultTableModel mostrar(String buscar) {
        ...
        sql = "select idoficios,idotrabajador,(select nombre from persona_trabajador where idpersona_trabajador=idotrabajador) as nombre_trab,"
                + "(select apaterno from persona_trabajador where idpersona_trabajador=idotrabajador)as apaterno_trab,"
                + "(select amaterno from persona_trabajador where idpersona_trabajador=idotrabajador)as amaterno_trab,"
